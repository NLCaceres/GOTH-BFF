	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, navItem := range slice.DistinctBy(navItems, strings.ToLower) {
			if !strings.Contains(navItem, "-") {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/view/index/Navbar.templ`, Line: 17, Col: 29}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/view/index/Navbar.templ`, Line: 18, Col: 60}
				}
